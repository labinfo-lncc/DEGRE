...
# DEGRE function
DEGRE <- function(count_matrix, num_reps, p_value_adjustment = "BH",
  ...
  cores <- detectCores()
  no_cores <- round(((round(cores/3))*2.5)-1)
...
## Running the DEGRE function
#results <- DEGRE(count_matrix = newDF,
#                 num_reps = 14,
#                 p_value_adjustment = "BH",
#                 design_matrix = control_and_BPD,
#                 formula = "treats + (1|sex)")
